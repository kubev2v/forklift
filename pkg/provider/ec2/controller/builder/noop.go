...
// Secrets is a no-op for EC2 - populator secrets created by ensurer, not builder.
...
// PodEnvironment is a no-op for EC2 - Ec2VolumePopulator controller handles AWS credentials via secrets.
