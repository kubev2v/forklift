...
func main() {
	...
	// Define flags (following vsphere-copy-offload-populator.go naming conventions)
	...
	// vSphere discovery flags (using same env vars as vsphere-copy-offload-populator.go)
