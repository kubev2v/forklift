...
To prevent overloading ESXi hosts during concurrent migrations, the vsphere-copy-offload-populator uses a distributed lease mechanism based on Kubernetes Lease objects. This ensures that heavy operations like storage rescans are serialized per ESXi host.
