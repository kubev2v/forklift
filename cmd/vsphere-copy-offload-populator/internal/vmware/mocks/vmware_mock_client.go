...
//
//	mockgen -destination=internal/vmware/mocks/vmware_mock_client.go -package=vmware_mocks github.com/kubev2v/forklift/cmd/vsphere-copy-offload-populator/internal/vmware Client
//
