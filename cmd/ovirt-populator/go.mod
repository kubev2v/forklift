module forklift.konveyor.io/ovirt-populator

go 1.18

require (
	github.com/kubev2v/lib-volume-populator v0.0.0-20230123163556-dbd0a2e6b1bf
...
// Debug: use a local modified lib-volume-populator instead of remote
//replace github.com/kubernetes-csi/lib-volume-populator => ./lib-volume-populator
