module certificate-tool

go 1.23.0

require (
	github.com/kubev2v/forklift/cmd/vsphere-xcopy-volume-populator v0.0.0-20250414122456-a2c36061ea72
...
require (
	...
	github.com/netapp/trident v0.0.0-20240628081112-cb68cb389d9d // indirect
