...
func (mr *MockClientMockRecorder) Logout(arg0 any) *gomock.Call {
...
// GetHostByRef mocks base method.
func (m *MockClient) GetHostByRef(arg0 context.Context, arg1 string) *object.HostSystem {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetHostByRef", arg0, arg1)
	ret0, _ := ret[0].(*object.HostSystem)
	return ret0
}

// GetHostByRef indicates an expected call of GetHostByRef.
func (mr *MockClientMockRecorder) GetHostByRef(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetHostByRef", reflect.TypeOf((*MockClient)(nil).GetHostByRef), arg0, arg1)
}
