...
def main():
    ...
    print(f">>>>>>>>> secure-vmkfstools-wrapper version {SCRIPT_VERSION} starting", file=sys.stderr)
    ...
    try:
        ...
        print(f">>>>>>>>> Executing operation: {operation} with args: {arg1}, {arg2}", file=sys.stderr)
