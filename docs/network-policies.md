...
- **Port Requirements:** Port 54323 required for imageio-daemon direct streaming (54322 deprecated)
...
# Port 54322 (deprecated imageio-proxy) removed from network policies
```
...
- ✅ **Successful oVirt migrations** (ports 443 + 54323, deprecated 54322 removed)
