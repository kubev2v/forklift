...
//
//	mockgen -destination=internal/populator/mocks/storage_mock_client.go -package=storage_mocks github.com/kubev2v/forklift/cmd/vsphere-xcopy-volume-populator/internal/populator StorageApi
//
