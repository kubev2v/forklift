...
require (
	...
	github.com/kubev2v/forklift v0.0.0-20251201013611-d4d1610e79df // indirect
	...
	github.com/yaacov/kubectl-mtv-mcp v0.0.7 // indirect
	github.com/yaacov/tree-search-language/v6 v6.0.11 // indirect
