...
import (
	...
	"github.com/kubev2v/forklift/pkg/controller/map/storage/handler"
...
func (r MapPredicate) Create(e event.TypedCreateEvent[*api.StorageMap]) bool {
	libref.Mapper.Create(event.CreateEvent{Object: e.Object})
	return true
}

func (r MapPredicate) Update(e event.TypedUpdateEvent[*api.StorageMap]) bool {
	object := e.ObjectNew
...
func (r MapPredicate) Delete(e event.TypedDeleteEvent[*api.StorageMap]) bool {
