...
var _ = Describe("vSphere builder", func() {
	...
	Context("mapNetworks Calico annotations", func() {
		...
		It("emits 3 distinct annotation sets when multiple NICs reference the same Calico Network via distinct NADs", func() {
			...
			pairs := []v1beta1.NetworkPair{
				{Source: ref.Ref{ID: "src-a"}, Destination: v1beta1.DestinationNetwork{Type: "multus", Namespace: "test", Name: "calico-nad-a"}},
				{Source: ref.Ref{ID: "src-b"}, Destination: v1beta1.DestinationNetwork{Type: "multus", Namespace: "test", Name: "calico-nad-b"}},
				{Source: ref.Ref{ID: "src-c"}, Destination: v1beta1.DestinationNetwork{Type: "multus", Namespace: "test", Name: "calico-nad-c"}},
			}
