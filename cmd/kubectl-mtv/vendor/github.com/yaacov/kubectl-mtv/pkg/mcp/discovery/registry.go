...
func (r *Registry) GenerateReadOnlyDescription() string {
	...
	sb.WriteString("RULE: Always set one of namespace or all_namespaces (MCP cannot see kubeconfig defaults).\n")
	sb.WriteString("RULE: Leave other optional flags unset unless the user asks.\n")
	return sb.String()
}
