module github.com/kubev2v/forklift/cmd/vsphere-copy-offload-populator
...
require (
	...
	github.com/kubev2v/forklift v0.0.0-20260604192648-c0113cb61882
...
require (
	...
	kubevirt.io/api v1.8.3 // indirect
