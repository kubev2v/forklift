...
//
//	mockgen -destination=ontap_api_mock.go -package=ontap github.com/netapp/trident/storage_drivers/ontap/api OntapAPI
//
...
func (m *MockOntapAPI) LunSetAttribute(ctx context.Context, lunPath, attribute, fstype, arg4, luks string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LunSetAttribute", ctx, lunPath, attribute, fstype, arg4, luks)
	ret0, _ := ret[0].(error)
	return ret0
}

// LunSetAttribute indicates an expected call of LunSetAttribute.
func (mr *MockOntapAPIMockRecorder) LunSetAttribute(ctx, lunPath, attribute, fstype, arg4, luks any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LunSetAttribute", reflect.TypeOf((*MockOntapAPI)(nil).LunSetAttribute), ctx, lunPath, attribute, fstype, arg4, luks)
}
...
func (m *MockOntapAPI) NVMeNamespaceCreate(ctx context.Context, ns api.NVMeNamespace) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOntapAPIMockRecorder) VolumeDestroy(ctx, volumeName, force any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
