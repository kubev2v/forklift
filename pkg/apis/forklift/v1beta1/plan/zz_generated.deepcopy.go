...
func (in *VM) DeepCopyInto(out *VM) {
	*out = *in
	...
	if in.RDMAsLun != nil {
		in, out := &in.RDMAsLun, &out.RDMAsLun
		*out = new(bool)
		**out = **in
	}
	if in.PreserveStaticIPs != nil {
		in, out := &in.PreserveStaticIPs, &out.PreserveStaticIPs
		*out = new(bool)
		**out = **in
	}
	if in.ExcludeNICsFromStaticIPs != nil {
		in, out := &in.ExcludeNICsFromStaticIPs, &out.ExcludeNICsFromStaticIPs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
