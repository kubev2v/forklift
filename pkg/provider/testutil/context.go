...
func (b *ContextBuilder) Build() *plancontext.Context {
	...
	if b.provider != nil {
		b.plan.Referenced.Provider.Source = b.provider
	}

	// Set up network map reference in plan
	if b.networkMap != nil {
		b.plan.Referenced.Map.Network = b.networkMap
	}

	// Set up storage map reference in plan
	if b.storageMap != nil {
		b.plan.Referenced.Map.Storage = b.storageMap
	}
