...
func (r *KubeVirt) EnsureVM(vm *plan.VMStatus) error {
	...
	for _, pvc := range pvcs {
		...
		pvc.OwnerReferences = createOwnerReferences(virtualMachine.ObjectMeta, metav1.TypeMeta{APIVersion: "kubevirt.io/v1",
			Kind: "VirtualMachine"})
...
func (r *KubeVirt) createPodToBindPVCs(vm *plan.VMStatus, pvcNames []string) (err error) {
	...
	pod := &core.Pod{
		ObjectMeta: meta.ObjectMeta{
			Namespace:       r.Plan.Spec.TargetNamespace,
			OwnerReferences: createOwnerReferences(r.Plan.ObjectMeta, r.Plan.TypeMeta),
...
func createOwnerReferences(objMeta metav1.ObjectMeta, typeMeta metav1.TypeMeta) []meta.OwnerReference {
