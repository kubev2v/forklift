---
title: vsphere-copy-offload-populator
authors:
  - "@rgolangh"
reviewers:
  - "@mnecas"
...
The vSphere XCOPY Volume-Populator is a populator implementation located under cmd/vsphere-copy-offload-populator
...
## Summary
The vsphere-copy-offload-populator provides a mechanism to perform storage-level data copy offload when migrating
