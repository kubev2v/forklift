...
// Creates PVCs, Ec2VolumePopulator CRs, secrets with AWS credentials in target namespace.
...
// Converts instances to VirtualMachine specs, volumes to PVCs, creates Ec2VolumePopulator CRs, maps instance types.
...
// DestinationClient returns destination client for managing Ec2VolumePopulator ownership.
// Sets PVC owner references on populators to enable automatic garbage collection.
