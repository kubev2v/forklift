...
To create PowerStore Credentials Secret, refer this [README](https://github.com/kubev2v/forklift/blob/main/cmd/vsphere-copy-offload-populator/README.md#secret-with-storage-provider-credentials) for more details.
