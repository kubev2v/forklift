...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/alternatives-1.24-2.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "1535bb31ef6b02ae628f82e05de480be4c3765ee0770a932a30d4da0e718ce5d",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/binutils-2.35.2-59.el9.x86_64.rpm",
    ],
)

rpm(
    name = "binutils-gold-0__2.35.2-59.el9.x86_64",
    sha256 = "21e709f93c9cea79bb357c8a845aa1e7b5b713ee8100e363a543da71dad9ef98",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/binutils-gold-2.35.2-59.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/crypto-policies-20240828-2.git626aa59.el9.noarch.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/elfutils-debuginfod-client-0.192-2.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/elfutils-default-yama-scope-0.192-2.el9.noarch.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/elfutils-libelf-0.192-2.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/elfutils-libs-0.192-2.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/expat-2.5.0-4.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/glib2-2.68.4-16.el9.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-0__2.34-148.el9.x86_64",
    sha256 = "b96a9c1f5b320d5480074dda01a881229e1edde0d7af02267f8b8d3c4c9665c0",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/glibc-2.34-148.el9.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-common-0__2.34-148.el9.x86_64",
    sha256 = "6ca6ea312e24a25bffc72aa9c958600e305f81b426748947b2d37a2d6a049f34",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/glibc-common-2.34-148.el9.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-devel-0__2.34-148.el9.x86_64",
    sha256 = "33d280899990698025791cd28bf5e7715fdeb75b81d273f120e93d0e8fbc734b",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/AppStream/x86_64/os/Packages/glibc-devel-2.34-148.el9.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-headers-0__2.34-148.el9.x86_64",
    sha256 = "016bf8f07cc66e59192ce865e2d7ec58b91c849486e23a4717c7c1aa35bf33f5",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/AppStream/x86_64/os/Packages/glibc-headers-2.34-148.el9.x86_64.rpm",
    ],
)

rpm(
    name = "glibc-langpack-ayc-0__2.34-148.el9.x86_64",
    sha256 = "294e296a6ff4d6fea44a639ae4421f97359e873b4024cbe83e06dedb7c1071ad",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/glibc-langpack-ayc-2.34-148.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/json-c-0.14-11.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/keyutils-libs-1.6.3-3.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/krb5-libs-1.21.1-4.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "feb64b4ee0b6c70e2df46555629e3399b602f7c6740c3012b6dce86fded2ede9",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/libbrotli-1.0.9-7.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "74117bc5982f730c0e02c67af2a02e59fdffbfed4c8b08474ce87438cfaa7f47",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/libcom_err-1.46.5-6.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "990a9418915ea2ad3e2602e57d16c8cd3018dbd3872ee10f3ac6d8596c2291f0",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/libevent-2.1.12-8.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "802bcae31f9a8c7ced42c6c71d60ffd870e5b0e8d4ccf77583dd8cb3a7f9e960",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/libsemanage-3.6-3.el9.x86_64.rpm",
    ],
)

rpm(
    name = "libsepol-0__3.6-2.el9.x86_64",
    sha256 = "e34f37b9627571e18307776138a208a451f48643ec20279cc09fd94abc7a9ec3",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/libsepol-3.6-2.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "c195e9981376059479ecb8864a400e7eb5c9b70446b46d0ba39a473ae476a793",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/libtool-ltdl-2.4.6-46.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/libzstd-1.5.5-1.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/numactl-libs-2.0.19-1.el9.x86_64.rpm",
    ],
)

rpm(
    name = "openldap-0__2.6.8-3.el9.x86_64",
    sha256 = "045f7ccfe4a0eb79e5cdfcea1c303489e29752424fa202d5534dbb6c46e18d84",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/openldap-2.6.8-3.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/openssl-libs-3.2.2-6.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/p11-kit-0.25.3-3.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/p11-kit-trust-0.25.3-3.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/python3-3.9.21-1.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/python3-libs-3.9.21-1.el9.x86_64.rpm",
    ],
)
...
rpm(
    name = "qemu-img-17__9.1.0-8.el9.x86_64",
    sha256 = "221a5b734315e500d054ee4ace26e936dec4dc4bf8ff1cd3595f59773c220056",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/AppStream/x86_64/os/Packages/qemu-img-9.1.0-8.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    sha256 = "1ea6f8a4cfba1a7030c8f51137022bf71a0bd8585174cf6276bc62bb74abb09e",
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/shadow-utils-4.9-12.el9.x86_64.rpm",
    ],
)
...
rpm(
    ...
    urls = [
        "https://composes.stream.centos.org/development/latest-CentOS-Stream/compose/BaseOS/x86_64/os/Packages/tzdata-2024b-3.el9.noarch.rpm",
    ],
)
