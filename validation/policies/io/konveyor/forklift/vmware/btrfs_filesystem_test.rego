...
test_vm_without_btrfs_no_concerns {
...
test_vm_with_btrfs_creates_concern {
...
test_mixed_filesystems_partial_concerns {
...
test_missing_filesystem_type_no_concern {
    count(concerns) == 0 with input as {
        "guestId": "ubuntu64Guest",
        "guestDisks": [
            {
...
test_empty_filesystem_type_no_concern {
    count(concerns) == 0 with input as {
        "guestId": "ubuntu64Guest",
        "guestDisks": [
            {
