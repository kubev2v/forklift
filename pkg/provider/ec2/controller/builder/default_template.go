...
// YAML from VMBuildValues. It replicates the exact output of the current map*-based
// EC2 builder, ensuring backward compatibility.
//
// The template produces YAML that unmarshals into cnv.VirtualMachineSpec.
